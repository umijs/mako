...
assert(
  trim(files["index.js"]).includes(`__mako_require__.ensure("src/index.css?asmodule")`),
  "should find ensure chunk"
);

assert(
  files["index.js"].includes(`__mako_require__.bind(__mako_require__, "src/index.css?asmodule")`),
