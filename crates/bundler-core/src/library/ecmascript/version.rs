...
pub(super) struct EcmascriptLibraryChunkVersion {
...
impl EcmascriptLibraryChunkVersion {
    ...
    pub async fn new(
        ...
        Ok(EcmascriptLibraryChunkVersion {
...
#[turbo_tasks::value_impl]
impl Version for EcmascriptLibraryChunkVersion {
    #[turbo_tasks::function]
    fn id(&self) -> Vc<RcStr> {
