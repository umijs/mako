    ...
    function getOverwrittenModule(moduleCache, id) {
        ...
        if (!module1) {
            if (createModuleWithDirectionFlag) {
                ...
                module1 = createModuleWithDirection(id);
            } else {
                module1 = createModuleObject(id);
            }
 ...
 */ function esmExport(bindings, id, dynamic) {
        ...
        let exports1;
        if (id != null) {
            module1 = getOverwrittenModule(this.c, id);
            exports1 = module1.exports;
        } else {
            module1 = this.m;
            exports1 = this.e;
        }
        module1.namespaceObject = exports1;
        esm(exports1, bindings, dynamic);
    }
    contextPrototype.s = esmExport;
    function ensureDynamicExports(module1, exports1) {
        let reexportedObjects = REEXPORTED_OBJECTS.get(module1);
 ...
 */ function dynamicExport(object, id) {
        ...
        const reexportedObjects = ensureDynamicExports(module1, exports1);
 ...
 */ function interopEsm(raw, ns, allowExportDefault) {
    ...
    function esmImport(id) {
        const module1 = getOrInstantiateModuleFromParent(id, this.m);
 ...
 */ // Used by the backend
    ...
    function instantiateModule(id, sourceType, sourceData) {
        ...
        const context = new Context(module1, exports1);
        try {
            moduleFactory(context, module1, exports1);
        } catch (error) {
            module1.error = error;
            throw error;
        }
 ...
 */ function loadScript(scriptUrl) {
    ...
    function factory() {
        const runtimeModuleIds = [
            "[project]/runtime/browser_library_commonjs_external/input/index.js [library-client] (ecmascript)"
        ];
        let exports1;
        for(let i = 0; i < runtimeModuleIds.length; i++){
            const module1 = moduleCache[runtimeModuleIds[i]];
            if (module1.error) throw module1.error;
            exports1 = module1;
        }
        if (exports1) {
            // any ES module has to have `module.namespaceObject` defined.
            if (exports1.namespaceObject) return exports1.namespaceObject;
            // only ESM can be an async module, so we don't need to worry about exports being a promise here.
            const raw = exports1.exports;
            return exports1.namespaceObject = interopEsm(raw, createNS(raw), raw && raw.__esModule);
        }
    }
    ...
    [
        "main.js",
        "[externals]/root ExternalValue commonjs ../external.cjs [external] (root ExternalValue commonjs ../external.cjs, umd)",
        (__turbopack_context__)=>{
            "use strict";
            let mod;
            if (typeof exports === 'object' && typeof module === 'object') {
                mod = __turbopack_context__.x("../external.cjs", ()=>require("../external.cjs"));
            } else {
                mod = globalThis["ExternalValue"];
            }
