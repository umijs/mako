 ...
 */ function loadScript(scriptUrl) {
    ...
    function factory() {
        const runtimeModuleIds = [
            "[project]/runtime/browser_library_promise_external/input/index.js [library-client] (ecmascript)"
        ];
        let exports1;
