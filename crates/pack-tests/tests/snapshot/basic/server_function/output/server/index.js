...
// Dummy runtime
    ...
    [
        "index.js",
        "[project]/basic/server_function/input/actions.ts [server] (ecmascript)",
        ...
        "[project]/basic/server_function/input/admin.ts [server] (ecmascript)",
        (__turbopack_context__)=>{
            "use strict";
            __turbopack_context__.s([
                "createUser",
        ...
        "[project]/basic/server_function/input/register.ts [server] (ecmascript)",
        (__turbopack_context__)=>{
            "use strict";
            __turbopack_context__.s([
                "RUNTIME_ACTIONS",
        ...
        "[project]/basic/server_function/input/server.ts [server] (ecmascript)",
