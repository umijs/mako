    ...
    [
        ...
        (__turbopack_context__)=>{
            ...
            if (typeof exports === 'object' && typeof module === 'object') {
                mod = __turbopack_context__.x("react-dom", ()=>require("react-dom"));
            } else {
                mod = globalThis["ReactDOM"];
            }
        ...
        (__turbopack_context__)=>{
            ...
            let mod;
            if (typeof exports === 'object' && typeof module === 'object') {
                mod = __turbopack_context__.x("emotion-styled", ()=>require("emotion-styled"));
            } else {
                mod = globalThis["EmotionStyled"];
            }
            __turbopack_context__.v(mod);
        },
        81,
