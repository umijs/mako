...
pub use swc_core::ecma::transforms::{
    base as swc_ecma_transforms, compat as ecma_transforms_compat,
    module as swc_ecma_transforms_modules, optimization as swc_ecma_transforms_optimization,
    proposal as swc_ecma_transforms_proposals, react as swc_ecma_transforms_react,
