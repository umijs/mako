...
export interface LessLoaderOpts {
  ...
  sourceMap: any;
  /**
   * A plugin can be a file path string, or a file path string with a params object. Notice!
   * The params object must be a plain json. We will require the plugin file to get the plugin content.
