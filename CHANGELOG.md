...
* 新增 react 配置项，支持不同的 react runtime 参数配置 by [@sorrycc](https://github.com/sorrycc) in https://github.com/umijs/mako/pull/872
* 新增 mako.config.json 中有错误时，输出友好提示 by [@sorrycc](https://github.com/sorrycc) in https://github.com/umijs/mako/pull/875
